...
public class MessageController {
        ...
        public ResponseEntity<?> sendMessage(
                        ...
                        @Parameter(name = "X-Api-Key", description = "RapidAPI or internal API Key", required = true, in = ParameterIn.HEADER, example = "rapid_xxxxxxx") @RequestHeader("X-Api-Key") String apiKey,
                ...
                // 2. Validate session ownership (client-level, not apiKey-level)
